...
# Explain Keyword Arguments - Unpack Dictionary
...
def threadmain():
    ...
    # Defining a function inside of a function, to use that function to do many things at the same time.
    def timertick():
        try:
            ...
            # Gets an action from the queue and executes it, and puts the result in another queue.
            # If you want to read the results back later
